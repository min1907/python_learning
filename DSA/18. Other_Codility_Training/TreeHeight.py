...
where X is the value contained in the root and L and R denote the left and right subtrees, respectively. The tree from the above figure can be denoted as:
...
def solution(T):
    if T.l == None and T.r == None:  # l: left, r: right
        # Has no subtree
        return 0
    elif T.l == None:
